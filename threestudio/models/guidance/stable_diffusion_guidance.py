...
class StableDiffusionGuidance(BaseObject):
    ...
    def configure(self) -> None:
        ...
        if self.cfg.pretrained_lora_name_or_path != "":
            if self.cfg.lora_checkpoint != "":
                self.pipe.unet.load_attn_procs(self.cfg.pretrained_lora_name_or_path, subfolder=self.cfg.lora_checkpoint)
            else:
                self.pipe.unet.load_attn_procs(self.cfg.pretrained_lora_name_or_path)
